for(let i=1;i<=11;i++){
   ...
   a.innerHTML=`<img src="cover1.jpg" alt="1">
   <span class="songname">  song</span>
   <span class="animename">Anime Name</span>
    
   <span class="songlistplay" ><i class="fa-regular fa-1.5x fa-circle-play"  id=${i}></i></span>
  `;
   document.getElementsByClassName('songitemlist')[0].appendChild(a);
}
...
let songs=[
    ...
    {songname:"Opening ",filepath:"songs/11.mp3",animename:"Re-zero",coverpath:"cover/11.jpg"},
